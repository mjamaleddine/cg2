...
define(["jquery", "straight_line", "circle_line"],
        (function($, StraightLine, CircleLine) {
            ...
            var HtmlController = function(context, scene, sceneController) {
                ...
                $("#btnNewCircle").click((function() {
                    ...
                    var circle = new CircleLine([randomX(), randomY()], randomR(), style);
                ...
                var getInputField = function() {
                    ...
                    obj.lineStyle.width = parseFloat($("#ipLineWidth").attr("value"));
